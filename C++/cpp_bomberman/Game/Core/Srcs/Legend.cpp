//
// Legend.cpp for  in /home/menich_a/rendu/cpp_bomberman/work_in_progress/v6
// 
// Made by Anatole Menichetti
// Login   <menich_a@epitech.net>
// 
// Started on  Wed May 27 16:26:29 2015 Anatole Menichetti
// Last update Sat Jun 13 10:38:51 2015 Anatole Menichetti
//

#include "Legend.hpp"
#include <algorithm>

Legend::Legend(Character* const character, size_t const id, std::vector<Character*> &ennemies) :
...
*/
int	Legend::getBestWayRec(std::vector<std::vector <AObject*> > const &map, size_t const x, size_t const y, int const dist, std::vector<std::pair<size_t, size_t> > &analysed) const
{
...
*/
void	Legend::getOneBestWay(std::vector<std::vector <AObject*> > const &map,
...
**	Valeur absolue
*/
int	Legend::absoluteValue(int const value) const
{
...
*/
void	Legend::getBestWay(std::vector<std::vector <AObject*> > const &map, size_t const x, size_t const y, int choice[2])
{
...
bool	Legend::nextActionIsDangerous(std::vector<std::vector <AObject*> > const &map, char const action, size_t x, size_t y) const
{
  if (action == LEFT)
    x--;
  if (action == RIGHT)
...
*/
int     Legend::getNbrHit(std::vector<std::vector <AObject*> > const &map, size_t const x, size_t const y) const
{
  int   power;
  int   hit = 0;
...
*/
char	Legend::getNextAction(Field &field)
{
