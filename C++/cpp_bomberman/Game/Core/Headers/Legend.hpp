//
// Legend.hpp for  in /home/menich_a/rendu/cpp_bomberman/work_in_progress/v6
// 
// Made by Anatole Menichetti
// Login   <menich_a@epitech.net>
// 
// Started on  Wed May 27 16:23:42 2015 Anatole Menichetti
// Last update Sat Jun 13 10:38:41 2015 Anatole Menichetti
//
...
class	Legend : public Bot
{
  std::vector<Character*> const &_ennemies;

public:
  Legend(Character* const character, size_t const id, std::vector<Character*> &);
  virtual ~Legend() {};
