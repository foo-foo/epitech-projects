...
// Last update Sat Jun 13 09:53:38 2015 Anatole Menichetti
//

#ifndef _BONUS_SPEED_HPP_
# define _BONUS_SPEED_HPP_
...
{
public:
  BonusSpeed(int const y, int const x, gdl::Model& model) : ABonus(y, x, model) {};
  virtual ~BonusSpeed() {};
