/****************************************************************************
** Meta object code from reading C++ file 'scores.hpp'
**
...
#include "Menu/scores.hpp"
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'scores.hpp' doesn't include <QObject>."
...
const QMetaObjectExtraData Scores::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject Scores::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_Scores,
      qt_meta_data_Scores, &staticMetaObjectExtraData }
};
