...
// Last update Sun Apr 26 16:41:33 2015 Anatole Menichetti
//
...
bool	Resources::takeResources(PizzaType const type)
{
...
void	Resources::setResources(t_resource const &res)
{
  _doe = res.doe;
  _tomato = res.tomato;
...
bool	Resources::checkResource(PizzaType const type) const
{
